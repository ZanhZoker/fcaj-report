...
|---|---|---|
| Frontend | Cache static assets at CloudFront and keep only build artifacts in S3 | Proposed; deployment evidence pending |
| API and processing | Use Lambda's request-based model and right-size memory after observing duration | Data pipeline configuration confirmed; application deployment pending |
...
| Recommendation | Create Amazon Personalize resources only for evaluation or a scheduled demo and remove idle campaigns | Team/ML action; deployment evidence pending |
